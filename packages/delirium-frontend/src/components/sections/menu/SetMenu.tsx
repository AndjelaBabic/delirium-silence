...
export const SetMenus = () => {
  ...
  return (
    <Box id="menu" sx={{ py: { xs: 10, md: 18 }, backgroundColor: "var(--ds-dark)", color: "#e8e8e8" }}>
      <Container maxWidth="lg">
        <Box sx={{ mb: { xs: 8, md: 12 }, textAlign: "center" }}>
          ...
          <Typography sx={{ fontSize: { xs: "2rem", sm: "2.5rem", md: "3rem" }, fontWeight: 300, lineHeight: 1.2, letterSpacing: "0.01em" }}>
            {m.headline}
          </Typography>
        </Box>
              ...
              >
                <Box>
                  <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 1.5 }}>
                    <Typography sx={{ fontSize: { xs: "1rem", md: "1.05rem" }, fontWeight: 400, letterSpacing: "0.03em", color: "#e8e8e8" }}>
                      {menu.title}
                    </Typography>
                    {menu.tag && (
