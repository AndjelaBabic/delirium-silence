...
export const Footer = () => {
  const f = useSection<typeof translations.en.footer>("footer");
          ...
          <Grid size={{ xs: 6, md: 2 }}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              {f.days.map(({ day, time }: { day: string; time: string }) => (
                <Box key={day}>
                  <Typography
                    sx={{ fontSize: "0.8rem", color: "#e8e8e8", mb: 0.25 }}
                  >
                    {day}
                  </Typography>
          ...
          <Grid size={{ xs: 12, md: 4 }}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2.5 }}>
              ...
              <Box>
                ...
                <Link
                  href="mailto:deliriumsilence.reservations@gmail.com"
                  underline="none"
                  sx={{
                    fontSize: "0.85rem",
                    color: "#e8e8e8",
